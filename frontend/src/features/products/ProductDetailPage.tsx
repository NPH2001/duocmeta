    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-14 px-6 py-12 md:py-16">
      ...
      <section className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-start">
        ...
        <aside className="space-y-8 rounded-3xl border border-stone-200 bg-white/90 p-7 shadow-[0_22px_60px_rgba(28,25,23,0.06)]">
          ...
          <div className="border-y border-stone-200 py-6">
            ...
            <p className="mt-3 text-2xl text-stone-950">{product.priceLabel === "Backend priced" ? t("products.backendPriced") : product.priceLabel}</p>
              ...
              {product.variants.map((variant) => (
                ...
                >
                  ...
                  <span className="text-right">
                    <span className="block font-medium text-stone-950">{variant.priceLabel === "Backend priced" ? t("products.backendPriced") : variant.priceLabel}</span>
                    <span className="text-xs text-stone-500">{variant.statusLabel === "API pending" ? t("products.apiPending") : variant.statusLabel}</span>
                  </span>
                </label>
              ))}
            </div>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        <article className="rounded-2xl border border-stone-200 bg-white/88 p-6 lg:col-span-2">
          ...
          <h2 className="mt-5 text-3xl text-stone-950">{t("products.structuredDetail")}</h2>
